...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=uixVFIra#cy4qQ03ph3YZYF5L8zUO-w2KRnF6xa2e0RynG02J2U0' : process.env.SESSION_ID,
...
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Rada fala😂 semaje*" : process.env.ALIVE_MSG,
